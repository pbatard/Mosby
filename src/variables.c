...
STATIC CONST CHAR16 *AttemptMessage1[] = {
	...
	L"",
	L"",
	L"Note: If you don't want to reinstall all keys, but just make sure",
	L"that the Secure Boot vulnerabilities, that were known at the time",
	L"this application was built, are addressed, you  can  also  select",
	L"'No' here, and then run Mosby again with the '-u' option.         ",
	L"",
	L"",
...
STATIC CONST CHAR16 *AttemptMessage2[] = {
	...
	L"required for the installation of new Secure Boot keys.           ",
	L"",
	L"Enabling 'Setup Mode' usually requires going into your  BIOS/UEFI",
	L"firmware settings and manually changing the Secure Boot  options.",
	L"",
	L"Do you want to reboot to enable 'Setup Mode'?",
	NULL
...
STATIC CONST CHAR16 *AttemptMessage3[] = {
	...
	L"2)  If you see an option between 'Standard' and 'Custom' mode for",
	L"    Secure Boot, make sure 'Custom' is selected.                 ",
	L"3a) If you see an  option  (possibly  under 'Key Management')  to",
	L"    delete/clear all variables or keys, please select it.        ",
...
STATIC CONST CHAR16 *AttemptMessage4[] = {
	L"ERROR: Setup Mode is not enabled",
	L"",
	L"We are sorry to see that you are having so much trouble trying to",
	L"enable 'Setup Mode'. At this stage we would  recommend  that  you",
	L"check your manufacturer's documentation or look for  answers,  on",
	L"user support forums that are relevant to your hardware.          ",
	L"",
	L"It is quite unfortunate that there exist manufacturers that  make",
	L"it very difficult for users to set up their own Secure Boot keys,",
	L"despite the fact that 'Setup Mode' is an  integral  part  of  the",
	L"UEFI specifications for Secure Boot.                             ",
	L"",
...
STATIC CONST CHAR16 *ExitMessage1[] = {
	...
	L"These are your UNIQUE SECURE BOOT SIGNING KEYS,  and  you  should",
